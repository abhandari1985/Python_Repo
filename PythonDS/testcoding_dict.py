...
sort_net = {}
sort_net = sorted(netflix.values())
# print(sort_net)

# print(
#     netflix["White Island"],
#     netflix["Gerald's Game"],
#     netflix["Monkey Twins"],
#     netflix["Maynard"],
#     netflix["Gaga: Five Foot Two"],
#     netflix["Hilda"],
#     netflix["Rafinha Bastos: Ultimatum"],
#     netflix["The First Line"],
# )
# print(
#     netflix["Gerald's Game"] - netflix["White Island"],
#     netflix["Monkey Twins"] - netflix["Gaga: Five Foot Two"],
#     netflix["Gaga: Five Foot Two"] - netflix["Hilda"],
#     netflix["Rafinha Bastos: Ultimatum"] - netflix["The First Line"],
# )

netflix["Deliha 2, Views"] = "3943452"
netflix["Dragons: Rescue Riders"] = "3996388"
netflix["Rafinha Bastos: Ultimatum"] = "3575445"
netflix["Gaga: Five Foot Two, Views"] = "3756188"
...
netflix_last_week = {
    ...
    "Maniac": 268187,
    "Quincy": 139696,
    "Rafinha Bastos: Ultimatum": 105449,
    "The Good Cop": 73230,
...
old = {sorted(netflix)}
new = {sorted(netflix_last_week)}
print(old)
print(new)
# # Loop through keys in dict1
for key in netflix:
    print(key)
#     # Check if the key is also present in dict2
#     if key in netflix_last_week:
#         # Add the values for the common key
#         result_dict[key] = netflix[key] + netflix_last_week[key]
#     else:
#         # If the key is not in dict2, simply copy the value from dict1
#         result_dict[key] = netflix[key]

# # Loop through keys in dict2 to add any remaining keys not in dict1
# for key in netflix_last_week:
#     if key not in netflix:
#         result_dict[key] = netflix_last_week[key]
